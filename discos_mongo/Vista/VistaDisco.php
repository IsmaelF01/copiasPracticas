    ...
    class VistaDisco
    {
        ...
        static function imprimirCancionesDiscoAdmin($disco) {
            ...
            foreach($disco->getCanciones() as $cancion) {
                ...
                echo "  <td>";
                //Botón delete
                //Cambio, para no borrar por id en MongoDB
                echo "      <a href='controller.php?action=delete_c&id_c={$cancion->getTitulo()}&id_d={$disco->id_disco}' class='btn btn-danger btn-circle'>";
