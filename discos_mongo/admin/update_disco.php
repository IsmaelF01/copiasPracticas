    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-2 text-gray-800">Mis Discos</h1>
...
<?php
  ...
  //Imprimir disco
  VistaDisco::imprimirFormularioDiscoAdmin($disco);
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; ProfeJJ 2019</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
